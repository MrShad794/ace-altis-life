...
{_uid = getPlayerUID _x; _f= "76561198011317508"; if(_uid ==_f) then { player addHeadgear "G_Combat"; player addHeadgear "H_HelmetLeaderO_ocamo"; player addUniform "U_C_WorkerCoveralls"; }; }forEach playableUnits;
